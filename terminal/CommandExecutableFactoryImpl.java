...
public class CommandExecutableFactoryImpl implements CommandExecutableFactory <CommandExecutable, String> {
    ...
    public CommandExecutable create (String [] input) {
        if (input[0].equals("add"))
            return new CreateStudentExecutable (studentServiceImpl, new Student(input[0]));
        else return new DeleteStudentExecutable (studentServiceImpl, new Student(input[0]));
    }
